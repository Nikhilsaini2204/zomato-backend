...
public class CategoryController {
  ...
  public ResponseEntity<CategoryModel> createCategory(@PathVariable String restaurantId,
  ...
  public ResponseEntity<CategoryModel> createStandardCategory(
      @RequestBody CategoryModel categoryModel) {
  ...
  public ResponseEntity<List<CategoryModel>> getByTypeAndRestaurantID(
  ...
  public ResponseEntity<List<CategoryModel>> getByRestaurantName(
  ...
  public ResponseEntity<List<DishModel>> getDishesByRestaurantAndCategory(
      @RequestParam String restaurantName, @RequestParam String categoryName) {
    List<DishModel> dishes =
        categoryService.getDishesByRestaurantAndCategory(restaurantName, categoryName);
