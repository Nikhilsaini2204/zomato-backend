...
public class RestaurantController
{
  ...
  @GetMapping("/filters")
  public ResponseEntity<List<RestaurantModel>> getRestaurants(@RequestParam(required = false) String name, @RequestParam(required = false) String typeCuisine, @RequestParam(required = false) Boolean isAvailable)
  {
    List<RestaurantModel> restaurants = restaurantService.getRestaurantByFilter(name, typeCuisine, isAvailable);
  ...
  public ResponseEntity<RestaurantModel> rejectRequestStatus(
