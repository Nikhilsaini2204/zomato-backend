...
public class DishController {
  ...
  public ResponseEntity<DishModel> addDish(@RequestBody DishModel dish , @PathVariable String restaurantId ,@PathVariable String categoryId){
  ...
  public ResponseEntity<DishModel> updateDish(  @PathVariable String restaurantId,@PathVariable String dishId ,@RequestBody DishModel dish){
    DishModel dishModel = dishService.updateDish(dishId ,dish);
    return  new ResponseEntity<>(dishModel, HttpStatus.OK);
  }

  @GetMapping("/restaurant/{restaurantId}/dishes/{dishId}")
  public ResponseEntity<DishModel> getDishById(@PathVariable String restaurantId ,@PathVariable String dishId){
  ...
  public ResponseEntity<List<DishModel>> getDishesByRestaurantName(@RequestParam String name, @RequestParam(required = false) String dishName) {
  ...
  public ResponseEntity<List<RestaurantModel>> getRestaurantsByCategory(@RequestParam String categoryName) {
  ...
  public ResponseEntity<List<CategoryModel>> getCategoriesByRestaurant(@RequestParam String restaurantName) {
